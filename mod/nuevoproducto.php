    ...
    <nav class="navbar navbar-expand navbar-dark fondonav"> 
        <div class="collapse navbar-collapse" id="navbarsExample02">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active"> <a class="nav-link" href="dentalgroup.php"><span class="fas fa-home"></span> Inicio </a> </li>
					                    ...
					                    <form action="../php/guardarproducto.php" method="post"> 
						                    <div class="row">
						                        <div class="md-form col-lg-8 col-md-12 col-sm-12">
						                            <i class="fas fa-hammer prefix grey-text"></i>
						                            <input type="text" name="nombre" class="form-control" required>
						                            <label for="defaultForm-email">&nbsp;&nbsp; Nombre del Producto</label>
						                        </div> 
						                        <div class="md-form col-lg-4 col-md-12 col-sm-12">
						                            <i class="fas fa-minus-square prefix grey-text"></i>
						                            <input type="text" name="cantidadmin" class="form-control" required>
						                            <label for="defaultForm-pass">&nbsp;&nbsp; Cantidad Min</label>
						                        </div>						                        					                    	
						                    </div>     
						                    <div class="row">
						                        <div class="md-form col-lg-8 col-md-12 col-sm-12">
						                            ...
						                            <label class="margentitulos">&nbsp;&nbsp; Cantidad Ingresada</label>
						                        </div>	     	                    	
						                    </div>  
